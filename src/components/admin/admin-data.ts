...
export const seededRooms: AdminRoom[] = [
  {
    ...
    amenities: ["Queen bed", "Air conditioning", "Wi-Fi", "Fridge"],
  ...
  },
  {
    ...
    amenities: ["Queen bed", "Workspace", "Coffee and tea", "Wi-Fi"],
  ...
  },
  {
    ...
    occupancy: "2 guests",
    status: "active",
    image: "/imported/luxurytouchhotel/69-dtwin-4e58c0b300.jpg",
    amenities: ["Twin beds", "Air conditioning", "Work desk", "Wi-Fi"],
    summary: "Shared-room category for family, colleagues, and group stays.",
  },
  {
    ...
    summary: "The highest room category with suite comfort and executive feel.",
  },
];
